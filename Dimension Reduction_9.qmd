...
```{r}
result <- prcomp(s.vitals[, c("Systolic_BP", "Diastolic_BP")]) # Running PCA using last 2 vital signs
...
p <- ggplot(s.vitals, aes(Systolic_BP, Diastolic_BP)) +
...
clean_vitals <- s.vitals[, c("Age", "Temp_C", "Heart_Rate", "Systolic_BP", "Diastolic_BP", "Resp_Rate", "SpO2")]
